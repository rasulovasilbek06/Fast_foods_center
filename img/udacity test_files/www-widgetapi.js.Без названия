...
n.toJSON=function(){var a=this.N(!1);return oc(a,qc)};
n.N=function(a){if(this.l){if(this.j){var b=this.h,c;for(c in b)if(Object.prototype.hasOwnProperty.call(b,c)){var d=b[c].h;d&&d.N(a)}}}else{this.i.length=0;b=vc(this);b.sort();for(c=0;c<b.length;c++){d=this.h[b[c]];var e=d.h;e&&e.N(a);this.i.push([d.key,d.value])}this.l=!0}return this.i};
...
n.set=function(a,b){var c=new uc(a);this.j?(c.h=b,c.value=b.N(!1)):c.value=b;this.h[a.toString()]=c;this.l=!1;return this};
...
zc.prototype.toJSON=function(){var a=this.N(!1);return oc(a,qc)};
zc.prototype.N=function(a){if(this.h)for(var b in this.h){var c=this.h[b];if(Array.isArray(c))for(var d=0;d<c.length;d++)c[d]&&c[d].N(a);else c&&c.N(a)}return this.i};
zc.prototype.toString=function(){return this.N(!1).toString()};
zc.prototype.clone=function(){var a=this.constructor,b=oc(this.N(!1),rc);yc=b;a=new a(b);yc=null;Hc(a,this);return a};
